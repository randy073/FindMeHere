...
//      }
//    });
    Button connect0Button = (Button) findViewById(R.id.connect_button);
    connect0Button.setOnClickListener(new View.OnClickListener() {
      public void onClick(View v) {
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle("Please enter the user's email you want to connect to");
  ...
  public void onConnected(Bundle bundle) {
    if (Application.APPDEBUG) {
      Log.d("Connected to loc", Application.APPTAG);
    }
  ...
  public void onDisconnected() {
    if (Application.APPDEBUG) {
      Log.d("Disconnected from loc", Application.APPTAG);
    }
  }
